...
from aoc_2024.aoc_2024 import solve_day_02_pt_01, solve_day_02_pt_02
import pytest
...
def test_day_2_part_2(input: str) -> None:
   # test solution to part 2
   ans = solve_day_02_pt_02(input)
   assert 4 == ans, f"{ans=}"
...
if __name__ == "__main__":
    ...
    print(DayInterface(2).submit_day(solve_day_02_pt_02(real_input), part=2))
